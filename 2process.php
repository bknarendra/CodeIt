...
<div id="loading" class="loading-invisible">
  <img src="loading.gif">
  <p align="center" class="style1"> Please Wait...it may take some time!</p>
</div>
...
$locn{2}=$locn{4};
$locn{4}=$charc;
echo '<html><head><link rel="stylesheet" href="style.css"></head><body>Click on the following link to see your results <form action="result.php" method="post"><input type="hidden" name="plc" value="' . $locn . '"><input type="submit" name="Submit" class="myButton" id="submit_button" value="Result"></form></body></html>';
?>